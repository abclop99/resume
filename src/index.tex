\begin{document}
	...
	\begin{rSection}{Experience}
		...
		\begin{rSubsection}{Genvira Biosciences} {IT} {Mar 2024--Present} %{C}{D}
			\item Manage server
			\item Develop web app
		\end{rSubsection}

		\begin{rSubsection}{UC San Diego} {Virtual reality} {June--December 2022, Jan 2024--Present} %{C}{D}
